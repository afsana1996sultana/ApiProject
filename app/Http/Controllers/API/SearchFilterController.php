...
class SearchFilterController extends Controller
{
    public function search(Request $request, $keyword)
    {
        if (!empty($keyword)) {
            if ($request->model == 'category') {
                ...
                if ($keywordCount < 3) {
                    return response()->json([
                        'message' => 'Please provide at least three keywords for the search.',
                    ], 400);
                }
                ...
                return SaleResourceIndex::collection($sale);
    ...
    public function dateFilters(Request $request, $model)
    {
        if ($request->has('this_week')) {
            ...
            $sales = Sale::whereBetween('created_at', [$startDate, $endDate])->latest()->get();
            ...
            return SaleResourceIndex::collection($sales);
        }
    }
